...
x, fs = librosa.core.load('D:\\MIR-1K\\UndividedWavfile\\abjones_1.wav',sr=None)
v, a = repet_sim(x,fs)
librosa.output.write_wav('d:\\source_sep\\voice.wav',v,fs,norm=True)
librosa.output.write_wav('d:\\source_sep\\accom.wav',a,fs,norm=True)
